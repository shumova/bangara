...
var initHeaderHeight = function initHeaderHeight() {
  if (header) {
...
/* harmony import */ var _modules_toggle_init_toggle__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/toggle/init-toggle */ "./js/modules/toggle/init-toggle.js");
/* harmony import */ var _modules_page_nav_page_nav__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/page-nav/page-nav */ "./js/modules/page-nav/page-nav.js");
/* harmony import */ var _modules_details_details__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/details/details */ "./js/modules/details/details.js");
/* harmony import */ var _modules_form_init_form_validate__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/form/init-form-validate */ "./js/modules/form/init-form-validate.js");
/* harmony import */ var _init_header_height__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./init-header-height */ "./js/init-header-height.js");
/* harmony import */ var _modules_init_examples_slider_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/init-examples-slider.js */ "./js/modules/init-examples-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // ---------------------------------
  Object(_init_header_height__WEBPACK_IMPORTED_MODULE_9__["initHeaderHeight"])();
  Object(_utils_mobile_vh_fix_js__WEBPACK_IMPORTED_MODULE_0__["mobileVhFix"])();
  Object(_modules_toggle_init_toggle__WEBPACK_IMPORTED_MODULE_5__["initToggles"])();
  Object(_modules_page_nav_page_nav__WEBPACK_IMPORTED_MODULE_6__["initPageNav"])();
  Object(_modules_details_details__WEBPACK_IMPORTED_MODULE_7__["initDetails"])();
  Object(_modules_form_init_form_validate__WEBPACK_IMPORTED_MODULE_8__["initFormValidate"])();
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    Object(_modules_init_examples_slider_js__WEBPACK_IMPORTED_MODULE_10__["initExamplesSlider"])();
  });
});
...
/***/ "./js/modules/details/details.js":
/*!***************************************!*\
  !*** ./js/modules/details/details.js ***!
  \***************************************/
/*! exports provided: initDetails */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initDetails", function() { return initDetails; });
...
var Details = /*#__PURE__*/function () {
  ...
  _createClass(Details, [{
    ...
    key: "_summaryClickHandler",
    value: function _summaryClickHandler(evt) {
      evt.preventDefault();
    ...
    value: function _expand() {
      ...
      this._animation.onfinish = function () {
        return _this._animationFinishHandler(true);
      };
      this._animation.oncancel = function () {
        _this._isExpanding = false;
      };
    }
  }, {
    key: "_animationFinishHandler",
    value: function _animationFinishHandler(open) {
      this.el.open = open;
      this._animation = null;
      this._isClosing = false;
      this._isExpanding = false;
    ...
    value: function close() {
      ...
      this._animation.onfinish = function () {
        return _this2._animationFinishHandler(false);
      };
      this._animation.oncancel = function () {
        _this2._isClosing = false;
      };
    }
  }, {
    key: "open",
...
var initDetails = function initDetails() {
  return document.querySelectorAll('[data-details="details"]').forEach(function (el) {
    return new Details(el);
  });
};
...
var feedbackSuccessCallback = function feedbackSuccessCallback(e) {
  e.preventDefault();
  resetForm(e.target);
  var feedbackSuccessElement = document.querySelector('[data-modal=feedback-success]');
  if (!feedbackSuccessElement) {
    return;
  }
  _modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["modals"].open('feedback-success');
};
var feedbackErrorCallback = function feedbackErrorCallback(e) {
  e.preventDefault();
};
var callbacks = {
  base: {
...
/***/ "./js/modules/init-examples-slider.js":
/*!********************************************!*\
  !*** ./js/modules/init-examples-slider.js ***!
  \********************************************/
...
var initExamplesSlider = function initExamplesSlider() {
  var examplesSlider = document.querySelector('[data-examples]');
  if (!examplesSlider) {
    return;
  }
  var examplesSliderSettings = {
    delayValue: examplesSlider.dataset.delay || 4500,
    speedValue: examplesSlider.dataset.speed || 1800
  };
  var examplesSliderSlider = examplesSlider.querySelector('[data-examples-slider]');
  var examplesSliderPagination = examplesSlider.querySelector('[data-examples-pagination]');
  var initExamplesSliderSlider = function initExamplesSliderSlider() {
    return new window.Swiper(examplesSliderSlider, {
      slidesPerView: 1,
...
/***/ "./js/modules/page-nav/page-nav.js":
/*!*****************************************!*\
  !*** ./js/modules/page-nav/page-nav.js ***!
  \*****************************************/
/*! exports provided: initPageNav */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initPageNav", function() { return initPageNav; });
/* harmony import */ var _toggle_init_toggle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../toggle/init-toggle */ "./js/modules/toggle/init-toggle.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var PageNav = /*#__PURE__*/function () {
  ...
  _createClass(PageNav, [{
    ...
    key: "_disableToggleEvents",
    value: function _disableToggleEvents() {
      var _this = this;
      this.toggle.style.setProperty('pointer-events', 'none');
      setTimeout(function () {
        return _this.toggle.style.removeProperty('pointer-events');
      }, 400);
    }
  }, {
    key: "_documentClickHandler",
    value: function _documentClickHandler(evt) {
      var target = evt.target;
      var isOnToggleClick = target.closest('[data-page-nav="toggle"]');
      var isOnPageNavClick = target.closest('[data-page-nav="content"]');
      if (isOnToggleClick) {
        if (this.isOpen) {
          this.close();
        } else {
        ...
        evt.preventDefault();
        this.close();
        Object(_toggle_init_toggle__WEBPACK_IMPORTED_MODULE_0__["toggleOff"])(this.toggle);
      }
    }
  }, {
    key: "_documentKeydownHandler",
    ...
    value: function _windowResizeHandler() {
      ...
      setTimeout(function () {
        return _this2.content.classList.remove('no-transition');
      }, 400);
...
var initPageNav = function initPageNav() {
  return new PageNav();
};
...
/***/ "./js/modules/toggle/init-toggle.js":
/*!******************************************!*\
  !*** ./js/modules/toggle/init-toggle.js ***!
  \******************************************/
/*! exports provided: initToggles, toggleOff */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initToggles", function() { return initToggles; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toggleOff", function() { return toggleOff; });
var toggleOn = function toggleOn(toggle) {
  var name = toggle.dataset.toggleTarget;
  toggle.setAttribute('aria-pressed', 'true');
  toggle.setAttribute('aria-label', "Close ".concat(name ? name : 'menu'));
  toggle.classList.add('is-active');
};
var toggleOff = function toggleOff(toggle) {
  var name = toggle.dataset.toggleTarget;
  toggle.setAttribute('aria-pressed', 'false');
  toggle.setAttribute('aria-label', "Open ".concat(name ? name : 'menu'));
